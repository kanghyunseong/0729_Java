...
//				  String str2;
	...
	// 생성 시점 : 프로그램 실행과 동시에 메모리의 static영역에 해당
	// 소멸 시점 : 프로그램 종료!
	 ...
	 * => 예약어 순서는 상관없음 public final static으로 작성해도 돌아감
	 * => 한 번 지정한 값을 고정해서 쓰겠다. 무조건 초기화를 해야함
	 * 
	 * static : 공유의 목적
	 * final : 한 번 초기화 하고 죽었다 깨나도 안바꾸겠다.
	 * 
	...
	public static final String Java_Version = "221";
