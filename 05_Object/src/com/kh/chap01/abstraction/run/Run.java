...
import com.kh.chap01.abstraction.vo.*;
...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * => 클래스를 먼저 생성해야함 !
		 * 
		 * 클래스란 ? 각 객체들의 정보(속성, 행위)들을 담아내는 그릇 또는 설계도 또는 명세
		 * 
		 * 클래스 : VO(Value Object)
		 *
		 * 오늘의 숙제 !
		 ...
		 * 
		 * 개수 ) VO클래스 5개 + VO 관리 프로그램 5개
		 * 각 VO클래스의 최소 필드 수 5개
		 * 최소 한 개 이상의 필드 값을 변경할 수 있는 메소드 생성 --> Puppy클래스의 bark같은거
		 * 
		 * 메모리구조 그리기 
		 * 
		 */
