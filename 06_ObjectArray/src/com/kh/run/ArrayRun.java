...
public class ArrayRun {
	...
	public static void main(String[] args) {
		...
		// 객체배열의 선언 및 할당!
		// [ 표현법 ]
		// 참조자료형(클래스이름)[] 배열식별자 = new 참조자료형[배열크기];
		...
		for(int i = 0; i < restaurants.length; i++) {
			...
			System.out.println("주소지를 입력하세요 > ");
			String address = sc.nextLine();
			
			System.out.println("대표메뉴를 입력하세요 > ");
		...
		//System.out.println(restaurants[0].getStoreName());
