...
public class FileRun {
	...
	public static void main(String[] agrs) {
		...
		try {
			...
			System.out.println("파일 맞니 ? " + file2.getName());  
			System.out.println("파일 맞니 ? " + file2.getParent());  
			System.out.println("파일 맞니 ? " + file2.getAbsolutePath());  
			System.out.println("파일 맞니 ? " + file2.length());  
