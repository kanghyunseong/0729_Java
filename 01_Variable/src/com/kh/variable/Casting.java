...
public class Casting {
	 ...
	 * 자바에서 값을 처리하는 규칙 
	 * 
	 * 1. =(대입 연산자)를 기준으로 왼쪽 / 오른쪽이 같은 자료형이어야한다.
	 * => 같은 자료형에 해당하는 리터럴값만 대입할 수 있음.
	 * => 자로형이 다를 경우? == 값을 바꿔서 대입해야함.
	 * 
	 * 2. 같은 자료형들끼리만 연산이 가능함
	 * => 자료형이 다른데 연산이 하고싶다??
	 * 
	 * 3. 연산의 결과물도 동일한 자료형이어한다. 
	...
	public void autoCasting() {
		...
		// 정수가 실수로 변환될 떄 큰 사이즈의 정수타입이 작은 사이즈 실수타입으로 형변환
		// 4Byte float형이 long형보다 표현할 수 있는 값의 범위가 더 넓기 때문
		
		// 1 2 3
		// 1.0000001, 1.00000002, 1.0000~
