...
//		System.out.println("딸기라떼를 25잔 시키셨습니다. ");
		...
		// 자바에서 문자열값과 다른 형태의 값을 붙여서 사용하고 싶은 경우
		// + 기호를 사용
		...
		System.out.println("케로케로케로피 멜론라뗴를 30잔 시키셨습니다. ");
	...
	public void declareVariable() {
		 ...
		 * 
		 * 자료형(DataType) 변수식별자;
		 * 권장하는 방법은 아니지만 동일한 타입의 변수를 선언할 때는 한번에 선언가능
		 * int a, b, c; <-- 권장하지 않음
		 ...
		 *  
		 *  - 식별자를 생성할 떄 꼭 지켜야 하는 규칙!(안 지키면 안만들어짐)
		 *  
		 ...
		 *  2. 변수 명명 규칙 
		 *  - 명사적 의미를 갖게 만들어 줌
		 *  - 첫 글자는 소문자료 표기, 연결된 단어들을 첫글자를 대문자로 표기
		 *  
		 *  --> phoneNumber
		 *  
		 *  3. 메소드 명명 규칙
		...
		System.out.println(" 정수자료형1 : " + byteNumber);
		System.out.println(" 정수자료형2 : " + shortNumber);
		System.out.println(" 정수자료형3 : " + intNumber);
		System.out.println(" 정수자료형4 : " + longNumber);
		
		// 실수자료형 2개
		
		System.out.println(" 실수자료형1 : " + floatNumber);
		System.out.println(" 실수자료형2 : " + doubleNumber);
		
		// 단일문자자료형 1개
		
		System.out.println(" 단일문자자료형 : " + charString);
		...
		// 출력문의 종류
		// System.out.print();
		// System.out.println(); => 개행한다, 새로운행을만든다
		System.out.println("isTrue라는 변수에 대입한 값 : " + isTrue + ", char형은 : " + charString);
		
		// System.out.prinf(); => f는 format, 개행 안 함
		// isTrue라는 변수에 대입한 값 : false, char형은 : str
		System.out.printf("isTrue라는 변수에 대입한 값 : %b, char형은 : %c", isTrue, charString);
		
		// %b : true / false 타입의 변수 공간
		// %d : byte, short, int, long 정수형 변수 공간
		// %f : float, double 실수형 변수 공간
		// %c : char문자형 변수를 담기 위한 공간
		// %s : String문자열형 변수를 담기 위한 공간 
		
		System.out.printf("\ndoubleNumber의 값 : %.1f", doubleNumber);
		System.out.println("=========================================");
