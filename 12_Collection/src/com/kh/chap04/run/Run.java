...
public class Run {
	...
	public static void main(String[] args) {
		...
		aquarium.put("참치", new Fish("기름맛", "후토마키"));
		...
		aquarium.replace("참치", new Fish("고소한 맛", "구이"));
		...
		// Set으로 바꾸면 Iterator를 사용할 수 있기 때문에 반복이 가능
		
		// 1) keySet() 호출하기
		
		// 1_1> Map이 가지고 잇는 Key들만 Set에 담는다.
