...
public class Run {
	...
	public static void main(String[] args) {
		...
		// HashSet
		// Value값만 저장, index개념 없음 == 순서보장 X, 중복X
		// [표현법]
		...
		// 컴퓨팅사고 ==> 컴퓨터는 어떻게 동작하는가?????
		// 0011100001111010101001111
		...
		*/
		...
		/*
		 * equals() 호출의 결과가 == true이고 hashCode()의 반환값을 동등비교 연산자를 통해 비교했을때
		 * 값이 일치한다면 => 동일객체로 판단(중복저장을 하지 않음)
		 * 
