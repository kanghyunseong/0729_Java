...
public class StringController {
	 ...
	 * 2. 대입연산자를 이용해서 문자열 리러터럴 값을 대입하는 방법
	 * 
	 */
	...
	public void method1() {
		...
		// 1. String 클래스의 toString()경우
		// 실제 담겨있는 문자열 리터럴 value값을 반환하겠음 오버라이딩
	...
	public void method3() {
		...
		// 문자열 리터럴은 대입 연산자를 사용해 대입할 떄 
		// String Contant Pool 영역에 등록됨
		// 특 : 동일한 내용의 문자열 리;터럴이 존재할 수 없음
	...
	public void method4() {
		...
		// StringBuffer
		// Buffer == 임시저장공간
		// 문자열은 불변객체라서 내용물이 변경될 떄 마다 새로운 공간을 할당해서 집어넣는다.
	...
	public void StringMethod() {
		...
		new String(arr).chars().mapToObj(c -> (char)c).forEach(System.out::println);
		...
		// 8.문자열.toLowerCase(): String -> 싹다 소문자로 바꾸기
		
		Scanner sc = new Scanner(System.in);
	
		System.out.print("정말 하시곘어요(Y/N)");
		String answer = sc.nextLine();
		//String upperAnswer = answer.toUpperCase();
		if(answer.equals("Y") || answer.equals("y")) {
			System.out.println("나 찐으로 해야겠다 못참곘다");
		}
